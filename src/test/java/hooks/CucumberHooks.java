...
public class CucumberHooks {
	...
	public CucumberHooks(DriverContext driverContext) {
	...
	public void itShouldRunAfterEachScenario(Scenario scenario) throws IOException {
		if(scenario.isFailed()) {
			...
			scenario.attach(takesScreenshot.getScreenshotAs(OutputType.BYTES), "image/png", "Attached Failed Scenario Snapshot.");
		}
		driver.quit();
